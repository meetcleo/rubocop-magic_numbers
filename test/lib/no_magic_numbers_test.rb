...
module Custom
  class NoMagicNumbersTest < Minitest::Test
    ...
    def test_detects_methods_that_explicitly_return_magic_integers
      inspect_source(<<~RUBY)
        def test_method
          return 1
        end
      ...
      assert_offense(
        cop_name: cop.name,
        violation_message: described_class::MAGIC_RETURNS_MSG
      )
    end

    def test_detects_methods_that_explicitly_return_magic_floats
      inspect_source(<<~RUBY)
        def test_method
          return  1.0
        end
    ...
    def test_detects_methods_that_implicitly_return_magic_integers
      inspect_source(<<~RUBY)
        def test_method
          1
        end
    ...
    def test_detects_methods_that_implicitly_return_magic_floats
      inspect_source(<<~RUBY)
        def test_method
          1.0
        end
